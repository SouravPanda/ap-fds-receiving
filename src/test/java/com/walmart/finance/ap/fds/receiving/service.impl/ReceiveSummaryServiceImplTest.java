...
public class ReceiveSummaryServiceImplTest {
    ...
    public void updateReceiveSummaryTest() {
        ...
        Mockito.when(receiveSummaryServiceImpl.updateReceiveSummary(receivingSummarySearch, vendorNumber, countryCode)).thenReturn(receivingSummarySearch);
    }
    ...
    public void updateReceiveSummaryLineTest() {
        ...
        ReceivingLine receivingLine = new ReceivingLine("112|1804823|8264|18|0|1995-10-17|1995-10-17T18:45:21|122", "4665267",
                ...
                0, 1.9, "LL");
        String id = "553683865|999997|6565|0|99|0|0";
        String lineId = "553683865|999997|6565|0|99|0|0|122";
        Mockito.when(mongoTemplate.findById(eq(id), eq(ReceiveSummary.class), eq("receiving-summary"))).thenReturn(receiveSummary);
        Mockito.when(mongoTemplate.findById(eq(lineId), eq(ReceivingLine.class),eq("receiving-line"))).thenReturn(receivingLine);
       // Mockito.when(mongoTemplate.findById(id, ReceiveSummary.class, "receiving-summary")).thenReturn(receiveSummary);
       // Mockito.when(mongoTemplate.findById(lineId, ReceivingLine.class, "receive-line")).thenReturn(receivingLine);
        ...
        Mockito.when(receiveSummaryServiceImpl.updateReceiveSummaryAndLine(receivingSummaryLineSearch, countryCode,vendorNumber)).thenReturn(receivingSummaryLineSearch);
    }
}
