...
public class ReceiveLineServiceImplTest {
    ...
    Assert.assertEquals(receiveLineServiceImpl.getLineSummary("78887","1", "1", "777","87","88",
        1,1,"creationDate",Sort.DEFAULT_DIRECTION).toString(),pageImplResponse.toString());
