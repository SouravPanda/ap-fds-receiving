package com.walmart.store.receive.consumer.src.main.java;//Copyright (c) Microsoft Corporation. All rights reserved.
        ...
        try {
            while (true) {
                ...
                for(ConsumerRecord<Long, String> cr : consumerRecords) {
                    MongoClient mongoClient = new MongoClient(new MongoClientURI("mongodb://fds-db-dev:qH6rTKJmjuO9Y67BfXWijNjTsJMSJuwPjDivaWEN0XeYCTwBl43Gy3QYMkj51fl3287I5FcSjEYsrBYdgwaYfw==@fds-db-dev.documents.azure.com:10255/?ssl=true&replicaSet=globaldb"));

                    //Query query = new Query(Criteria.where("name").is("joshna"));
                    MongoTemplate mongoTemplate = new MongoTemplate(mongoClient,"test_1");


                    mongoTemplate.insert(cr.value(),"col2");
                    //Object obj = mongoTemplate.find(query,Object.class,"col1");
                    //mongoTemplate.insert(obj,"receive-summary");
