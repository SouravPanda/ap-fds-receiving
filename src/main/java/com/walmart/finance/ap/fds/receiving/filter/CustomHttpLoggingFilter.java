...
/**
 * Spring Web filter for logging httpRequest and httpResponse.
 *
 *
 */
...
public class CustomHttpLoggingFilter extends OncePerRequestFilter {
    ...
    private final String ACTUATOR_URL="/actuator";
    ...
    protected void beforeRequest(ContentCachingRequestWrapper request, ContentCachingResponseWrapper response) {
        if (log.isInfoEnabled()&&!request.getRequestURI().contains(ACTUATOR_URL)) {
